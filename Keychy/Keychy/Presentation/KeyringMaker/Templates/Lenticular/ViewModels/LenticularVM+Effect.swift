...
extension LenticularVM {
    ...
    var sortedAvailableSounds: [Sound] {
        availableSounds.sorted { sound1, sound2 in
            ...
            let priority1 = getSortPriority(isFree: sound1.isFree, isDownloaded: downloaded1)
            let priority2 = getSortPriority(isFree: sound2.isFree, isDownloaded: downloaded2)
    ...
    var sortedAvailableParticles: [Particle] {
        availableParticles.sorted { particle1, particle2 in
            ...
            let priority1 = getSortPriority(isFree: particle1.isFree, isDownloaded: downloaded1)
            let priority2 = getSortPriority(isFree: particle2.isFree, isDownloaded: downloaded2)
    ...
    func isOwned(soundId: String) -> Bool {
        EffectManager.shared.isOwned(soundId: soundId, userManager: userManager)
    }

    func isOwned(particleId: String) -> Bool {
        EffectManager.shared.isOwned(particleId: particleId, userManager: userManager)
    }
